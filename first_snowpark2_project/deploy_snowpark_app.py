...
os.system(f"snow snowpark deploy --replace --temporary-connection --account "pbzsblp-dev_account" --user "BADGEFOUR" --role "ACCOUNTADMIN" --warehouse "COMPUTE_WH" --database "DEMO_DB"")